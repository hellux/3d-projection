...
void matrix_test(void) {
    ...
    double B[][3] = {{10, 11, 12}, {13, 14, 15}, {16, 17, 18}};
    double C[3][3];
    double D[][2] = {{1, 2}, {3, 4}};
    double E[2][2];
    double mul[][3] = {{84,  90,  96 }, {201, 216, 231}, {318, 342, 366}};
    double scl[][3] = {{2,  4,  6 }, {8,  10, 12}, {14, 16, 18}};
    double inv[][2] = {{-2,    1  }, { 3/2, -1/2}};
    ...
    double F[3][2] = {{1, 2}, {3, 4}, {5, 6}};
   double G[2][3] = {{10, 11, 12}, { 13, 14, 15}};
    double H[3][3] = {{36, 39, 42}, {82, 89, 96}, {128, 139, 150}};
    double I[3][3];

    matrix_product(3, 2, F, 2, 3, H, I);
    assert(matrix_equal(3, 3, H, I));
}
